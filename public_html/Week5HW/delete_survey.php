...
<form method="POST">
    ...
    <?php if($thingId > 0):?>
	    <input type="submit" name="updated" value="Update Questions"/>
        <input type="submit" name="delete" value="Delete Questions"/>
    <?php elseif ($thingId < 0):?>
        <input type="submit" name="created" value="Create Questions"/>
    <?php endif;?>
</form>
